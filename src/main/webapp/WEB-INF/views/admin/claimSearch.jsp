...
$(document).ready(function(){
	...
	$("#searchBtn").click(function(){
		...
		if(searchWord.length==0){
			...
			location.href='${conPath}/searchClaimAfter.do?&searchWord='+searchWord;
		}
...
<c:if test="${ad_id!=null }">
 ...
 <div id="container">
   <div id="wrap">
 	<span class="big">완료전 1:1문의 보기</span>
 	<div class="row">
 	...
 	<div class="row">
	  <div class="col-lg-12" id="list_container">
	   	<span class="sub_caption">제목/내용 "${searchWord }" 검색결과 ${paging.total }개 - 최신순</span>	   
