...
public class Ppage {
	...
	public Ppage(String p_email, String n_num, String q_num, String con_num, String p_nickname, String p_photo1,
			String f_email, String f_nickname, String f_photo1, int cate_num, String cate_name, int r, int startRow,
			int endRow, String con_title, String con_content, String con_file1, String con_file2, String con_file3,
			int con_price, Timestamp con_date, String n_title, String n_content, Timestamp n_date, int n_hit, int n_del,
			String n_ip, String q_title, String q_content, Timestamp q_date, int q_price, int q_accept, int q_show,
			int q_star) {
		super();
