...
--    CATESUB_NUM NUMBER NOT NULL,
--    CATESUB_NAME VARCHAR2(100),
...
-- 프로멤버 INSERT문
INSERT INTO PROMEMBERS VALUES('asd@asd.com', '22', '정성훈', '정성훈', '010', '3976', '2237', '302-0778-5449-11', '농협', '서울',DEFAULT, '사진1',DEFAULT,DEFAULT,DEFAULT,'메세지','사진2', 1,NULL);
...
INSERT INTO NEWSFEED 
    VALUES('NEWSFEED'||NEWSFEED_SEQ.NEXTVAL,'asd@asd.com','제목','내용',SYSDATE,0,0,'127.0.0.1',2);
INSERT INTO NEWSFEED 
    VALUES('NEWSFEED'||NEWSFEED_SEQ.NEXTVAL,'asd@asd.com','제목2','내용2',SYSDATE,0,0,'127.0.0.1',2);
...
INSERT INTO CONTENTS 
    VALUES('CONTENTS'||CONTENTS_SEQ.NEXTVAL,'asd@asd.com','제목','내용',null,null,null,0,SYSDATE,2,0,0);
...
-- 자유게시판 INSERT문
INSERT INTO FBOARD(FB_NUM, FB_NAME, FB_TITLE, FB_CONTENT, FB_IP, FB_PHOTO)
    VALUES('FBOARD'||FBOARD_SEQ.NEXTVAL, '닉네임', '제목', '본문', '아이피', 'noimg.png');
...
-- 1:1문의 INSERT문
INSERT INTO CLAIM 
    VALUES('CLAIM'||CLAIM_SEQ.NEXTVAL,'asd@asd.com','제목','매미','답장하라는문의3',SYSDATE,'기타',0);
...
INSERT INTO FB_COMMENT(FC_NUM, FB_NUM, FC_NAME, FC_CONTENT, FC_GROUP,FC_PHOTO, FC_IP)
    	VALUES('FB_COMMENT'||FB_COMMENT_SEQ.NEXTVAL, 'FBOARD1', '이름', '본문', 'FB_COMMENT'||FB_COMMENT_SEQ.CURRVAL, '아이피');
SELECT FB.* FROM FB_COMMENT FB, FBOARD F WHERE F.FB_NUM= 'FBOARD21' AND F.FB_NUM = FB.FB_NUM ORDER BY FB.FC_GROUP, FB.FC_DATE; 
COMMIT; 
SELECT COUNT(*) AS CNT FROM FB_COMMENT;
SELECT COUNT(*) AS CNT FROM FB_COMMENT GROUP BY FB_NUM;
SELECT * FROM FBOARD WHERE FB_DEL = 0 ORDER BY FB_DATE DESC;
SELECT FB_NUM, COUNT(*) AS CNT FROM FB_COMMENT GROUP BY FB_NUM;
SELECT F.*, FC.TOTAL  FROM FBOARD F, (SELECT FB_NUM, COUNT(*) AS TOTAL FROM FB_COMMENT GROUP BY FB_NUM) FC
    WHERE F.FB_NUM=FC.FB_NUM(+);
SELECT * FROM
		    (SELECT ROWNUM RN, A.* FROM
		    (SELECT F.*, FC.TOTAL  FROM FBOARD F, (SELECT FB_NUM, COUNT(*) AS TOTAL FROM FB_COMMENT GROUP BY FB_NUM) FC
    		WHERE F.FB_NUM=FC.FB_NUM(+) ORDER BY FB_DATE DESC) A)
		    WHERE RN BETWEEN 1 AND 6;
INSERT INTO REPORT VALUES(REPORT_SEQ.NEXTVAL, '정성훈', '사유', default);
UPDATE PROMEMBERS SET P_PHOTO1 = 'noimg.png' WHERE P_EMAIL = 'asd@asd.com';
commit;
INSERT INTO QUESTION VALUES('QUESTION1','pro1@pro.com','finder1@finder.com',7,
'질문1','내용1',sysdate,100,1,1,1);
SELECT Q.*,P.P_NICKNAME FROM QUESTION Q,PROMEMBERS P WHERE P.P_EMAIL = Q.P_EMAIL AND Q.Q_NUM = 'QUESTION2';
SELECT * FROM NEWSFEED;
INSERT INTO PPAGE (P_EMAIL,N_NUM)VALUES('asd@asd.com','NEWSFEED2');
SELECT * FROM CONTENTS;
INSERT INTO PPAGE(P_EMAIL,CON_NUM)VALUES('asd@asd.com','CONTENTS1');
SELECT * FROM QUESTION;
INSERT INTO PPAGE(P_EMAIL,Q_NUM)VALUES('pro1@pro.com','QUESTION1');
SELECT * FROM QANSWER;
SELECT COUNT(*) 
		    FROM(SELECT ROWNUM R, A.* FROM (SELECT Q.*, F_NICKNAME, F_PHOTO1, CATE_NAME 
		            ...
		            WHERE Q.Q_NUM = PP.Q_NUM 
				            AND Q.P_EMAIL = PP.P_EMAIL AND PP.P_EMAIL=P.P_EMAIL AND PP.P_EMAIL = 'pro20@pro.com'
